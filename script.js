...
function playAgainstComputer(playerType) {
    ...
    if (intentosRestantes === 0) {
        ...
        if(ganador == 1){
            mensajeElement.textContent = `El ganador es Player 1 Y el Player 2 perdio`;
            mensajeElement.style.color = 'green'; // Cambiar color del mensaje a verde
        }else {
            mensajeElement.textContent = `El ganador es Player 2 y el Player 1 perdio`;
            mensajeElement.style.color = 'green'; // Cambiar color del mensaje a verde
        }
    }
}
...
function handlePlayerOptions(playerType) {
    ...
    if (intentosRestantes > 0) {
        if (!player1Choice) {
            ...
            mensajeElement.style.color = 'red'; // Cambiar color del mensaje a negro
            mensajeElement.style.backgroundColor = '#02399f';
        } else {
        ...
        if(ganador == 1){
            mensajeElement.textContent = `El ganador es Player 1 El Player 2 perdio`;
            mensajeElement.style.color = 'green'; // Cambiar color del mensaje a verde
        }else {
            mensajeElement.textContent = `El ganador es Player 2 El Player 1 perdio`;
            mensajeElement.style.color = 'green'; // Cambiar color del mensaje a verde
        }
